...
import com.example.msi_gl62.karn.ui.home.holder.ListFoodHolder
import com.example.msi_gl62.karn.ui.home.holder.ListFoodPopularHolder

class AdapterListFood(private var coWork: List<FoodModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
